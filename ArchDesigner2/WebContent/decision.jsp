<%@page import="webservice.CallWebService"%>
...
<body>
		...
		<div id="page-wrapper">
            ...
            <form action="DecisionBusiness" method="post">
				...
				<tbody>
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Conceptselect"
							style="width: 250px;">
                                <%String authKey = (String)session.getAttribute("theAuth");
                                  CallWebService cws = new CallWebService();
                                  ArrayList<String> concept = cws.getConcepts(authKey);
                                  for(int i=0;i<concept.size();i++){
                                %>
                                  <option value="<%=i %>"><%= concept.get(i) %></option>
                                <%} %>
						</select></td>
					</tr>
										<tr>
						...
						<td style="border: none;"><select class="form-control" id="relationselect"
							style="width: 250px;">
                            <%
                                  ArrayList<String> relation = cws.getrelationlist(authKey);
                                  for(int i=0;i<relation.size();i++){
                                %>
                                  <option value="<%=i %>"><%= relation.get(i) %></option>
                                <%} %>
						</select></td>
					</tr>
										<tr>
					...
					<tr>
						...
						<td style="border: none;"><textarea class="form-control" id="Remarktext" name="remarkArea" rows="4"
