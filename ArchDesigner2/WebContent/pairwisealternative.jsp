...
%>
            ...
            <form action="PairwisealternativeBusiness" method="post"> 
			...
			<table id="PWAtable" style="border: none;">
				...
				<td style="border: none;">&nbsp;</td>
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Qltyselect" name="QltName"
							style="width: 250px;">
								<% 
							try {
							    Class.forName("org.postgresql.Driver");
				...
				<td style="border: none;">&nbsp;</td>
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Alt1select" name="Alt1Name"
							style="width: 250px;">
								<% 
							try {
							    Class.forName("org.postgresql.Driver");
				...
				<td style="border: none;">&nbsp;</td>
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Alt2select" name="Alt2Name"
							style="width: 250px;">
							<% 
							try {
							    Class.forName("org.postgresql.Driver");
