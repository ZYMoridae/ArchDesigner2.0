...
<body>
	...
	<div id="page-wrapper">
		...
		<table id="decisiontable" style="border: none;">
					...
					<td style="border: none;"><select class="form-control" id="appselect"
						style="width: 250px;">
                                 <%
                                  ...
                                  ArrayList<String> appName = as.GetApplicationList();
                                  for(int i=0;i<appName.size();i++){
                                %>
                                  <option value="<%=i %>"><%= appName.get(i) %></option>
                                <%} %>
            ...
            <tr>
                    <td style="border: none;"><label>No</label></td>
                    <td style="border: none;"><input class="form-control" type="text" id="Notxt" name="NoName"
