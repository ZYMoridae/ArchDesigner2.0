...
<body>
	...
	<div id="container">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ArchDesigner v2.0</a>
            </div>
            <!-- /.navbar-header -->
    ...
    <!-- /#wrapper -->
		...
		<div id="page-wrapper">
			<br>
			<div style="font-weight: bold; width: 300px;" id="divPwqList">Pairwise
				Quality List</div>
			...
			<table id="PWQtable" style="border: none;">
				<tbody>
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Stkselect"
							style="width: 250px;">
								<% 
							try {
							    Class.forName("org.postgresql.Driver");
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Qlt1select"
							style="width: 250px;">
								<% 
							try {
							    Class.forName("org.postgresql.Driver");
					...
					<tr>
						...
						<td style="border: none;"><select class="form-control" id="Qlt2select"
							style="width: 250px;">
									<% 
							try {
							    Class.forName("org.postgresql.Driver");
